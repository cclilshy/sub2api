...
curl -sSL https://raw.githubusercontent.com/cclilshy/sub2api/refs/heads/override/main/override/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone https://github.com/cclilshy/sub2api.git
cd sub2api/override/deploy
...
```bash
curl -sSL https://raw.githubusercontent.com/cclilshy/sub2api/refs/heads/override/main/override/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download the latest release from [GitHub Releases](https://github.com/cclilshy/sub2api/releases)
