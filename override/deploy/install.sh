...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/cclilshy/sub2api/refs/heads/override/main/override/deploy/install.sh | bash
#
...
Documentation=https://github.com/cclilshy/sub2api
